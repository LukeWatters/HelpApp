...
import 'package:testapp/shared/const.dart';
    ...
    if (_formKey.currentState.validate()) {
      ...
      await _auth
        ...
        if (result != null) {
          ...
          await HelperFunction.saveuserEmailSharedPreference(email);
          await HelperFunction.saveuserNameSharedPreference(fullName);
