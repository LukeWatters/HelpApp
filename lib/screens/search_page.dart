    ...
    return hasUserSearched
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              return groupTile(
                _userName,
                searchResultSnapshot.docs[index].get(FieldPath(["groupId"])),
                searchResultSnapshot.docs[index].get(FieldPath(["groupName"])),
                searchResultSnapshot.docs[index].get(FieldPath(["admin"])),
              );
            })
        : Container();
  }
